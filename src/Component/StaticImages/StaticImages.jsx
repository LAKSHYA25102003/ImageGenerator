      ...
      <div className="w-[80%] flex flex-col gap-10 justify-center items-center">
        ...
        <div className="grid max-[1000px]:grid-cols-1 max-[1488px]:grid-cols-2 grid-cols-3 gap-10">
          <motion.div
            ...
            className="ai relative card-zoom max-[438px]:w-[300px] max-[600px]:w-[350px] max-[1000px]:w-[500px] overflow-hidden shadow-xl w-[400px] min-h-[600px]"
          >
          ...
          <motion.div
            ...
            className="ai relative  overflow-hidden max-[438px]:w-[300px] max-[600px]:w-[350px] max-[1000px]:w-[500px] shadow-xl  w-[400px] min-h-[600px]"
          >
